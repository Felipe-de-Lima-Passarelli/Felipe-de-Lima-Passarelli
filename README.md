...
- **TypeScript** aplicado ao Front-End, com foco em tipagem, segurança e escalabilidade
- **Tailwind CSS**, priorizando produtividade, consistência visual e design escalável
- **Next.js**, aprofundando conceitos de rotas, renderização (SSR/SSG) e arquitetura de aplicações modernas
- **JavaScript avançado**, consolidando fundamentos essenciais para código limpo e previsível
- **Boas práticas de código e organização de projetos Front-End**

---

### 📚 Conhecimentos complementares
- **Front-End:** CSS Modules, boas práticas de UX/UI, SEO básico
- **Python:** Automação, Web Scraping, manipulação e análise de dados (Pandas, NumPy)
- **Banco de dados:** MySQL
- **Metodologias ágeis:** Scrum
- **Ferramentas de dados e IA:** Power BI, modelos e ferramentas de IA generativa
